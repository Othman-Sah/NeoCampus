...
class ApplyRemiseUseCase
{
    ...
    public function execute(ApplyRemiseDTO $dto): array
    {
        return DB::transaction(function () use ($dto) {
            ...
            if ($fee['statut'] === 'paye') {
                throw new FinanceException("Cannot apply discount to an already paid fee.", 400);
            }
            ...
            $remise = $this->feePort->applyRemise($dto->frais_id, $remiseData);
