...
class UpdateSeanceUseCase
{
    ...
    public function execute(int $id, SeanceDTO $dto): array
    {
        // Check for conflicts: overlapping slots for either the teacher or class (excluding current ID)
        ...
        return $this->seanceRepository->update($id, $dto->toArray());
    }
}
