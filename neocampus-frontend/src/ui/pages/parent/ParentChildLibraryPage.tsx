...
import { useChildLoans } from '@/application/useCases/useParentPortal'
...
export const ParentChildLibraryPage: React.FC = () => {
  const { childId } = useParams<{ childId: string }>()
  const { data: loans = [], isLoading } = useChildLoans(Number(childId))
    ...
    <div className="space-y-6 animate-fade-in text-neutral-900">
      ...
      <div>
        ...
        <p className="text-[11px] font-semibold text-neutral-400 uppercase tracking-wide">
          Monitor your child's borrowed library books and due dates
        </p>
      </div>
          ...
          <Card className="bg-white border border-neutral-100 shadow-sm rounded-2xl overflow-visible">
            <CardHeader className="pb-3 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
              <div>
                ...
                <CardDescription>All media resources currently assigned to your child</CardDescription>
              </div>
              ...
              {isLoading ? (
                <div className="flex flex-col items-center justify-center py-16 gap-3">
                  ...
                  <p className="text-[10px] font-bold text-neutral-400 uppercase tracking-widest">
                    Fetching child library records...
                  </p>
                </div>
                ...
                <div className="text-center py-16 space-y-2 border border-dashed border-neutral-200 rounded-2xl bg-neutral-50/50">
                  ...
                  <p className="text-[11px] text-neutral-400 font-semibold max-w-xs mx-auto leading-relaxed">
                    Your child currently has no checked out media resources or no matches.
                  </p>
                </div>
              ) : (
        ...
        <div className="space-y-6">
          ...
          <Card className="bg-white border border-neutral-100 shadow-sm rounded-2xl p-5 space-y-3">
            ...
            <ul className="space-y-2.5 text-[11px] text-neutral-500 font-medium leading-relaxed list-disc list-inside">
              <li>Ensure your child returns books on time to avoid checkout lockouts.</li>
              <li>Encourage quiet reading habits and regular book exchanges.</li>
              <li>Outstanding fines can be resolved at the school administrative desk.</li>
            </ul>
          </Card>
        </div>
...
export default ParentChildLibraryPage;
